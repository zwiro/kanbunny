    ...
    <FocusLock>
      <>
        <motion.aside
          ...
          {...sideMenuAnimation}
          className="fixed bottom-0 left-0 top-16 w-11/12 overflow-y-scroll bg-zinc-800 px-24 py-8 text-2xl lg:w-8/12 lg:px-36 lg:text-3xl xl:w-6/12 [&>button]:my-0"
        >
          {!isLoading ? (
          ...
          {!data?.length && !isLoading && (
            <p className="pt-12 text-center text-neutral-500">
              no projects yet
            </p>
          )}
        </motion.aside>
