  ...
  return (
    <FocusLock group="aside-nav">
      <motion.aside
        ...
        {...sideMenuAnimation}
        className="fixed bottom-0 left-0 top-0 z-40 w-11/12 overflow-y-scroll bg-zinc-800 px-24 py-8 pt-24 text-2xl lg:w-8/12 lg:px-36 lg:text-3xl xl:w-6/12 [&>button]:my-0"
      >
        {!isLoading ? (
